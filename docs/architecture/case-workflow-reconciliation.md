...
Migration `fffbf06a7c8d` is additive on top of the current structural head
`fffaef5a6b7c`. The original candidate revision collided with the existing task
deadline migration and was reassigned during reconciliation.
