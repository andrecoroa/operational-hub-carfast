# Diagnóstico UX — documentos oficiais na ficha da viatura

## Estado observado

A ficha já organiza a informação num cabeçalho resumido, ações rápidas e quatro separadores internos: regras, manutenção, financeiro e documentação/histórico. O excesso de informação é controlado porque apenas um painel interno está visível de cada vez. Criar uma quinta zona permanente ou repetir formulários no resumo aumentaria a densidade e duplicaria navegação.

## Intervenção mínima escolhida
