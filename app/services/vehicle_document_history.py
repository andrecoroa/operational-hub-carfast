...
DOCUMENT_HISTORY_QUICK_CLASSIFICATIONS: dict[str, list[tuple[str, str]]] = {
    ...
    "pads": [("undefined", "Por definir"), ("front", "FR"), ("rear", "TR")],
    "discs": [("undefined", "Por definir"), ("front", "FR"), ("rear", "TR")],
    "tyres": [("undefined", "Por definir"), ("front", "FR"), ("rear", "TR"), ("puncture", "Furo")],
        ...
        rows.append(
            {
                ...
                "supplier_nif": metadata.get("supplier_nif") or metadata.get("tax_id") or metadata.get("nif_fornecedor") or "",
                ...
                "ocr_status": metadata.get("ocr_status") or metadata.get("ocr_validation_status") or document.status,
                "extraction_state": "validado" if document.status == "classified" else "por_validar",
                "comparison_state": "validado" if document.status == "classified" else "por_validar",
                "comparison_label": "Validado" if document.status == "classified" else "Por validar",
