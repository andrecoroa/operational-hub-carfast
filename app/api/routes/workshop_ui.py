...
<body>
  ...
  <script>
    ...
    async function submitProcess(event) {
      ...
      try {
        const response = await fetch("/workshop/processes/phased", {
          method: "POST",
...
<body>
  ...
  <script>
    ...
    fetch(`/workshop/processes/${{processId}}`)
      .then((response) => {{
...
<body>
  ...
  <script>
    ...
    fetch("/workshop/processes").then(r => r.json()).then((items) => {
