...
INITIAL_PERMISSIONS = [
    *NAVIGATION_PERMISSIONS.items(),
    ...
    ("cases.read", "Consultar casos operacionais"),
    ("cases.write", "Gerir casos operacionais"),
    ("cases.close_override", "Fechar casos com processos ativos"),
    ("cases.reopen", "Reabrir casos operacionais"),
    ("processes.execute", "Executar processos em casos"),
    ("processes.delegate", "Delegar fases para tarefas"),
    ("processes.validate", "Validar fases sensíveis"),
    ("processes.publish", "Publicar versões de processos"),
    ("processes.reopen", "Reabrir processos"),
    ("phases.reopen", "Reabrir fases"),
]
