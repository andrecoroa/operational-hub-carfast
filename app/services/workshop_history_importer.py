...
REPORT_TYPE_TO_READING_TYPE = {
    ...
    "parametrizacaomanutencao": "maintenance_program",
    "parametrizacaointervalomanutencao": "maintenance_program",
    "parametrosmanutencaorecuperadosdoveiculo": "maintenance_program",
