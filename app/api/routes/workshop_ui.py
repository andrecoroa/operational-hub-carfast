    ...
    function renderSummary() {{
      ...
      document.querySelector("#summary").innerHTML = `
        <div class="summary-kpis">
          <div><span>Fase atual</span><strong>${{safe(PHASES[processData.current_phase_code] || processData.current_phase_code)}}</strong></div>
